...
### Set logo to "ws1"
### Placeholders for "item" and "appPath" so script can fins and replace those items

LOGO="ws1" # "mosyleb", "mosylem", "addigy", "microsoft", "ws1", "kandji"

item="##ITEM##" # enter the software to install
# Examples: cyberduck, handbrake, textmate, vlc
appPath="##APP_PATH##"
# Examples: Cyberduck.app, Handbrake.app, Textmate.app, VLC.app

installomatorOptions="BLOCKING_PROCESS_ACTION=silent_fail NOTIFY=success" # Separated by space
